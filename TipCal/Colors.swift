...
struct Colors {
    ...
    static let lightGrey        = UIColor(red: 226/255, green: 226/255, blue: 226/255, alpha: 1.0) /* #e2e2e2 */
    static let black            = UIColor(red: 0.0/255.0, green: 0.0/255.0, blue: 0.0/255.0, alpha: 1.0)
    static let white            = UIColor(red: 255.0/255.0, green: 255.0/255.0, blue: 255.0/255.0, alpha: 1.0)
    static let pink             = UIColor(red: 221/255, green: 94/255, blue: 137/255, alpha: 1.0)
    static let babyBlue         = UIColor(red: 0.9686, green: 0.7333, blue: 0.5922, alpha: 1.0)
    static let babyPurple       = UIColor(red: 201/255, green: 214/255, blue: 255/255, alpha: 1.0) /* #c9d6ff */
}
